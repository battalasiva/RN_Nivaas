    ...
    <Modal
      ...
      <View style={styles.overlay}>
        <View style={styles.container}>
            ...
            <Text style={styles.content}>Users are solely responsible for ensuring that their profile pictures are appropriate and relevant to the residential community context.NIVAAS bears no responsibility for any non-related, offensive, or inappropriate profile pictures uploaded by users</Text>
            ...
            <Text style={styles.content}>If you have any questions about these Terms, please contact us on Email : <Text onPress={sendSupportEmail} style={styles.emailText}>nivaas.connect@gmail.com</Text></Text>
            </View>
